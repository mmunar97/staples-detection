...
from staples_detection.base.staple_detection_result import GradientDirectionResult, GradientStapleDetectionResult


def generate_mask(image: numpy.ndarray,
...
def generate_gradient_staple_result(image: numpy.ndarray, gradient_method: StapleDetectionMethod, **kwargs) -> GradientDirectionResult:
    """
